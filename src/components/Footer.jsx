              ...
              <div className="mains_footer_second">
                  ...
                  <div className="main_footer_second footer_organic">
                      <div className='main_organic_footer'>
                          <img src="/organick.png"></img>
                      </div>
                      <p className="p">Simply dummy text of the printing and typesetting industry.
                          Lorem Ipsum simply dummy text of the printing</p>
                      <div className="footer_organic_img">
                          <div className="footer_img_circle">
                            <a href="https://www.instagram.com/"><img src="/Insta.png"></img></a></div>
                          <div className="footer_img_circle">
                            <a href="https://www.facebook.com/"><img src="/facebook.png"></img></a></div>
                          <div className="footer_img_circle">
                              <a href="https://twitter.com/"><img src="/twitter.png"></img></a></div>
                          <div className="footer_img_circle">
                              <a href="https://www.pinterest.com/"><img src="/Pintrest.png"/></a>
                            </div>
                      </div>
                  </div>
